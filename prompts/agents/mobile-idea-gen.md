...
- **Pain point mining**: Search Reddit (r/apps, r/androidapps, r/iphone) for frustration posts. Dig into threads — what are people saying in comments? What workarounds do they use? WebSearch the problem to understand how widespread it is.
- **News-driven opportunities**: Search news for industry changes, regulatory shifts, cultural moments. When something changes in the real world, what mobile experience becomes possible or necessary? Fetch the actual articles.
- **X/Twitter pulse**: Search X timeline for "I wish there was an app for", product complaints, viral moments. What are people frustrated about RIGHT NOW?
